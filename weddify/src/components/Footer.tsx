  ...
  return (
    <footer className="bg-black border border-b-4 border-zinc-600 text-white rounded-lg w-full p-4 mt-8">
      <div className="max-w-full mx-auto flex justify-between items-center">
        ...
        <a
            href="https://calendar.google.com/calendar/u/0/r/eventedit?text=Gaye+%26+Enes+Wedding&details=Join+us+for+our+wedding+celebration&location=1811+Albion+Rd,+Etobicoke,+ON+M9W+5W4&dates=20240819T193000Z/20240819T223000Z"
            target="_blank"
